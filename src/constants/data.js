...
export const NEEDS = ["significance","certainty","variety","growth","contribution","love","connection"];

export const NEED_COLORS = { significance:"#e74c3c",certainty:"#3498db",variety:"#f39c12",growth:"#27ae60",contribution:"#9b59b6",love:"#e91e8c",connection:"#1abc9c" };
...
export const CHALLENGE_MONTHLY = [
...
export const HOME_ACTIVITY_TASKS = HOME_ACTIVITIES.map(a => ({
...
export const HOME_ACTIVITY_REMINDERS = HOME_ACTIVITIES.map((a,i) => ({
  id: `ha${i+1}`,
  category: "home",
  icon: a.emoji,
...
export const ALL_REMINDERS = () => [...REMINDER_LIBRARY, ...HOME_ACTIVITY_REMINDERS];
